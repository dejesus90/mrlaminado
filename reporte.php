...
$this -> Cell(11);
    $this->Image('Imagnes/Logo mr laminado azul 1943x358.png',57,13,100);
$this->Ln(19);
$this->Cell(198,18,'No. de Remision: '.$_GET["id"],0,1,'C');
...
$pdf->Ln(2);
$pdf-> Cell(10,3.5, '____________________________________________________________________________________________', 0,0 , "L");
$pdf->Ln(3);
...
$pdf-> Cell(107,13.5, 'R.F.C:', 0,0 , "R");
$pdf->SetFont('Arial','',10);
$pdf->Ln(5);
$pdf-> Cell(82,3.5,"".utf8_decode($dtsc[1]), 0,0 , "L");
$pdf-> Cell(81,3.5,"".$dtsc[2], 0,0 , "R");
$pdf->Ln(5);
$pdf->SetFont('Arial','B',10);
...
while($mdts1=mysqli_fetch_array($mdts)){
    ...
    $pdf->Cell(49,3.6,$mdat1[0],0,0,"L");
    $pdf->SetFont('Arial','',10); //descri
    $pdf-> Cell(33,3.6,$mdts1[5],0,0,"C"); // largo
    $pdf-> Cell(-4,3.6,$mdts1[6],0,0,"C"); // ancho
    $pdf-> Cell(33,3.6,$mdts1[7],0,0,"C");// Pertenece Array [7]
    $pdf->Cell(-1,3.6,"$".number_format($mdts1[8], 2, '.', ''),0,0,'C');     //Precio Unitario
    $pdf->Cell(40,3.6,"$".number_format($total_linea, 2, '.', ''),0,0,'C'); //Importe
    $pdf->Ln(4); //nota
    $pdf->SetFont('Arial','',9);
    $pdf->Cell(49);
...
$pdf->SetFont('Arial','B',10);
$pdf->Cell(99,3.5,"Estos precios no incluyen el impuesto al valor agregado",0,0,"R");
$pdf->SetFont('Arial','',10);
$pdf-> Cell(75,3.5,"$".number_format($tot,2,'.',',') , 0,0 , "R");//Sub
...
$pdf->Ln(3);
$pdf->SetFont('Arial','',10);
$pdf-> Cell(115,3.5,"A T E N T A M E N T E" , 0,0 , "R"); 
//$pdf->Ln(4);
//$pdf->SetFont('Arial','',9);
//$pdf-> Cell(120,3.5,"Departamento de Cotizaciones" , 0,0 , "R"); 
$pdf->Ln(5);
$pdf->SetFont('Arial','',10);
$pdf-> Cell(109,3.5,"".utf8_decode("Jerico  Briseño") , 0,0 , "R");
$pdf->Ln(5);
$pdf-> Cell(110,3.5,"Gerente General" , 0,0 , "R");

$pdf->Ln(4);
$pdf->SetFont('Arial','',10);
$pdf-> Cell(112,3.5,"Movil. 18 01 05 02 " , 0,0 , "R");
$pdf->Ln(4);
$pdf->SetFont('Arial','',10);
...
$pdf->Ln(5);
$pdf-> Cell(50,3.5,"Nombre,Firma y Fecha" , 0,0 , "R");                               
$pdf->Ln(5);
$pdf->SetFont('Arial','',10);
$pdf->Ln(5);
$pdf-> Cell(70,3.5,"Entrego: ____________________________" , 0,0 , "L");
$pdf->Ln(5);
