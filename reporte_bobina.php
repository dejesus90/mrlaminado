...
class PDF extends FPDF {
	...
	function Header() {
		...
		$this->Ln(7);
		$this->Cell(186,18,'No. de Remision: '.$_GET["id"],0,1,'C');
...
$pdf->Ln(5);
$pdf->SetFont('Arial','B',9);
$pdf-> Cell(30,3.5, 'Cliente:', 0,0 , "L");
$pdf-> Cell(88,13.5, 'R.F.C:', 0,0 , "R");
$pdf->SetFont('Arial','',9);
$pdf->Ln(5);
...
$pdf->SetFont('Arial','',9);
$pdf->Ln(5);
$pdf-> Cell(59,3.5,$dtsc[3].", ".$dtsc[4].", ".$dtsc[6] , 0,0 , "L");
$pdf->Ln(5);
$pdf-> Cell(65,3.5,$dtsc[7].", ".$dtsc[8].",C.P. ".$dtsc[5] , 0,0 , "L");
$pdf->Ln(5);
...
$pdf->SetFont('Arial','',9);
$pdf->Cell(17,3.5,'Cant.',0,0,'L');
$pdf->Cell(45,3.5,'Bobina',0,0,'L');
//$pdf->Cell(-55,3.5,'Pedimento',2,0,'C');
$pdf->Cell(-33,3.5,'Ancho',0,0,'C');
$pdf->Cell(55,3.5,'Largo',0,0,'C');
$pdf->Cell(-33,3.5,'M2',0,0,'C');
$pdf->Cell(68,3.5,'Precio m2 USD',0,0,'C');
$pdf->Cell(-10,3.5,'Precio X Bobina USD',0,0,'C');
$pdf->Cell(71,3.5,'Tipo de Cambio',0,0,'C');
$pdf->Cell(-20,3.5,'Precio Unitario',0,0,'C');
$pdf->Ln(3);
...
while($mdts1=mysqli_fetch_array($mdts)){
   ...
   // $pdf->Ln(5); 
    ...
    $pdf->Cell(13,3.6,$mdts1['cantidad'], 0,0 , "J");  
    $pdf->Cell(29,3.6,$mdat1[0], 0,0 , "J");//larg
    //$pdf->Cell(20,3.6,$mdts1['um'],0,0,"J");   Pedimento
	 $pdf->Cell(10,3.6,$mdts1['ancho'],0,0,"J"); //largo
    $pdf->Cell(12,3.6,$mdts1['largo'],0,0,"J"); // m2
    $pdf->Cell(15,3.6,$m2,0,0,"J");            // Pertenece Array [7] 
    $pdf->Cell(29,3.6,"$".number_format($mdts1['costo'], 3, '.', ''),0,0,'J');    //Precio m2 usd 
	$pdf->Cell(28,3.6,"$".number_format($pbobina_usd, 2, '.', ''),0,0,'J');       //precio_unitario
	$pdf->Cell(25,3.6,$mdts1['tipo_cambio'],0,0,"J");                             // tipo de cambio
    $pdf->Cell(25,3.6,"$".number_format($precio_unitario, 2, '.', ''),0,0,'J');
    $pdf->Ln(4); //nota
	$pdf->SetFont('Arial','',7.5);
	$pdf->Cell(10);
	$pdf->MultiCell(40,3.5,"".utf8_decode($mdts1['nota'])," multi-line text string\nNew line\nNew line",30,0,'C');
...
$pdf->SetFont('Arial','',9);
//$pdf-> Cell(15,3.5,"Cantidad con letra" , 0,0 , "L");
$pdf->Ln(9);
$pdf->SetFont('Arial','',9);
...
$pdf->SetFont('Arial','',9);
$pdf-> Cell(162,3.5,"$".number_format($tot,2,'.',',') , 0,0 , "R");
$pdf->Ln(5);
...
$pdf->SetFont('Arial','',9);
$pdf->Ln(5);
$pdf-> Cell(70,3.5,"Recibio: ____________________________" , 0,0 , "L");
$pdf->Ln(5);
$pdf-> Cell(50,3.5,"Nombre y Firma" , 0,0 , "R");                               
$pdf->Ln(5);
$pdf->SetFont('Arial','',9);
$pdf->Ln(5);
$pdf-> Cell(70,3.5,"Entrego: _____________________________" , 0,0 , "L");
$pdf->Ln(5);
$pdf-> Cell(50,3.5,"Nombre y Firma" , 0,0 , "R");
