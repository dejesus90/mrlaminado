    ...
    <form method="POST" id="form1" autocomplete="off" action="rem_up.php">
      <table id="tb1" class="table table-condensed">
        ...
        <td>
          ...
          <td>
            <select name="articulo1" class="form-control input-sm">
              <option value="0">--Selecciona--</option>
              <?php
              include ("conex.php");
          ...
          <td>
            <select  name="um1" id="um1" class="form-control input-sm" onchange="calculam2(1);">
              <option value="1">Pedimento 1</option>
              <option value="2">Pedimento 2</option>
              <option value="3">Pedimento 3</option>
              <option value="3">Pedimento 4</option>
              <option value="3">Pedimento 5</option>
              <option value="3">Pedimento 6</option>
            </select>
          </td>
          <td>
            <input type="text" name="largo1" id="largo1" class="form-control input-sm td"   onkeyup="calculam2(1)" value="0"/>
